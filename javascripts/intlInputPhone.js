...
(function ($) {
	...
	IntlInputPhone.DEFAULTS = {
		...
		error_message: {
			"INVALID_PH_N": "Invalid phone number, please enter correct number",
	...
	IntlInputPhone.prototype.getDefaultCountry = function () {
		...
		else throw new Error('Invalid default country.');
	}
				...
				if (v.toUpperCase() == value.cca2) {
					var c = $this.arrayToKeysValues(value).keys,
						d = $.map(value, function (vl, ix) {
							if (ix == 'cca2') return vl.toLowerCase();
							else return vl;
						});
	...
	IntlInputPhone.prototype.showError = function (el, message) {
		if (typeof this.display_error == 'string' && this.display_error == 'on') {
			...
			el.popover('show');
		} else if (typeof this.display_error == 'object') {
	...
	IntlInputPhone.prototype.hideError = function (el) {
		if (typeof this.display_error == 'object') {
...
! function () {
	...
	function A(d, A) {
		...
		N.prototype = A.prototype, d.ha = A.prototype, d.prototype = new N, d.prototype.constructor = d, d.ma = function (d, N, $) {
			for (var e = Array(arguments.length - 2), n = 2; n < arguments.length; n++) e[n - 2] = arguments[n];
	...
	function $(d, A) {
		for (var N = d.split("%s"), $ = "", e = Array.prototype.slice.call(arguments, 1); e.length && 1 < N.length;) $ += N.shift() + e.shift();
		return $ + N.join("%s")
	}
	...
	function b(d, A) {
		for (var N = h(d.h()), $ = 0; $ < N.length; $++) {
			...
			if (m(A, n)) {
				...
				var t = 11 == e.b || 10 == e.b;
				if (e.f)
					for (var e = M(A, n) || [], r = 0; r < e.length; r++) G(d, n, t ? e[r].clone() : e[r]);
	...
	function M(d, A) {
		...
		if (d.g) {
			if (!(A in d.a)) {
				...
				if (null != N)
					if (e.f) {
						for (var n = [], t = 0; t < N.length; t++) n[t] = $.a(e, N[t]);
						N = n
					} else N = $.a(e, N);
				return d.a[A] = N
			}
	...
	function y(d, A) {
		var N;
		if (m(d, A)) N = v(d, A, void 0);
		else d: {
			if (N = d.f[A], void 0 === N.g) {
				var $ = N.j;
				if ($ === Boolean) N.g = !1;
				else if ($ === Number) N.g = 0;
				else {
					if ($ !== String) {
						N = new $;
						break d
	...
	function Y(d, A) {
		for (var N, $ = new B, e = d.length, n = 0; e > n; ++n) N = d.charAt(n), N = A[N.toUpperCase()], null != N && $.a(N);
		return $.toString()
	}
	...
	function sd(d, A, N, $, e) {
		...
		var t = d.toString();
		if (0 == t.length) n = 20;
		else if (NA.test(t)) t = t.replace(NA, ""), O(d), d.a(Z(t)), n = 1;
		else {
	...
	function hd(d, A, N, $) {
		...
		n = new F, $ && T(n, 5, A);
		d: {
			if (A = e.toString(), t = A.search(aA), t >= 0 && H(A.substring(0, t)))
				for (var r = A.match(aA), a = r.length, i = 1; a > i; ++i)
		...
		if (1 < $.length && "0" == $.charAt(0)) {
			for (T(n, 4, !0), d = 1; d < $.length - 1 && "0" == $.charAt(d);) d++;
			1 != d && T(n, 8, d)
		}
	...
	C.prototype.clone = function () {
		...
		for (var A = h(d.h()), N = {}, $ = 0; $ < A.length; $++) {
			...
			if (m(d, e.a))
				if (e.f) {
					var t = [];
					for (N[n] = t, n = 0; n < E(d, e.a); n++) t.push(this.b(e, v(d, e.a, n)))
		...
		if (this.b += d, null != A)
			for (var $ = 1; $ < arguments.length; $++) this.b += arguments[$];
		return this
	...
	F.prototype.h = function () {
		...
		for (var A = h(d.h()), N = [], $ = 0; $ < A.length; $++) {
			...
			if (m(d, e.a)) {
				...
				if (e.f) {
					N[n] = [];
					for (var t = 0; t < E(d, e.a); t++) N[n][t] = this.b(e, v(d, e.a, t))
				} else N[n] = this.b(e, v(d, e.a, void 0))
			}
		}
		return S(d, function (d, A) {
